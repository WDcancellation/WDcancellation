      ...
      <form onSubmit={handleOpenSaveDialog} className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs space-y-6 text-slate-800">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            ...
            الاستثناءات الافتراضية المحددة بالنظام: <strong>عضوية دولية</strong> (إعفاء انتفاع وإدارية)، <strong>بدون خصم مصاريف ادارية</strong> (إعفاء إدارية وفيزا)، <strong>جهة سيادية</strong> (إعفاء انتفاع). باقي الاستثناءات يمكن إضافة تأثير آلي لها أو خصمها يدوياً.
          </p>
